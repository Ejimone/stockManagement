...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-rb8&zegm&af&d*s$9fd&-#k!+hy46xbs8ke!t%ai5mj9vm%z8*')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config('DEBUG', default=False, cast=bool)

# Allow all hosts in production, but should be restricted in production
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '10.0.2.2', '*']

# Database URL for production (PostgreSQL on Render)
